package com.jumy.mapdemo.route;
...
import com.jumy.mapdemo.*;
import com.jumy.mapdemo.utils.AMapUtil;
import com.jumy.mapdemo.utils.BaseActivity;
import com.jumy.mapdemo.utils.OffLineMapUtils;
import com.jumy.mapdemo.utils.ToastUtil;
...
public class RouteActivity extends BaseActivity implements OnMarkerClickListener,
    ...
    @ViewById(R.id.imagebtn_roadsearch_startoption)
    ImageButton startImageButton;
    @ViewById(R.id.imagebtn_roadsearch_endoption)
    ImageButton endImageButton;
    @ViewById(R.id.autotextview_roadsearch_start)
    EditText startTextView;
    @ViewById(R.id.autotextview_roadsearch_goals)
    EditText endTextView;
    @ViewById(R.id.imagebtn_roadsearch_tab_transit)
    Button busButton;
    @ViewById(R.id.imagebtn_roadsearch_tab_driving)
    Button drivingButton;
    @ViewById(R.id.imagebtn_roadsearch_tab_walk)
    Button walkButton;
    @ViewById(R.id.imagebtn_roadsearch_search)
    ImageButton routeSearchImagebtn;
    @ViewById(R.id.map)
    MapView mapView;
